    ...
    public partial class StructFundForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (checkBoxBuyB.Checked)
            {
                ...
                if (tc != null)
                    tc.SendOrder(OrderType.CashBuy, BTicker, BQuantity.ToString(), "1.5", true, out bufferNotUsed);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (checkBoxBuyB.Checked)
                    tc.SendOrder(OrderType.CashSell, BTicker, BQuantity.ToString(), "1.5", true, out bufferNotUsed);
