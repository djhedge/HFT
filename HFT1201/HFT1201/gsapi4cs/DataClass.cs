    ...
    public class DataClass: TDFDataSource
    {
        ...
        */
        ...
        public string LoadDataDict()
        {
            ...
            //string sql = "select top 50 Ticker, Quantity, prevClose, PrevVolume from v_HFT_PrevCloseData  where NowDate =" + intDate.ToString() + "  and ticker='000897' and prevvolume>0 Order by ticker";//融券卖空用

            sql = "select Ticker, 100,Price_close ,AvgVol_5D from TotalAHist where HistDate=20151125";
