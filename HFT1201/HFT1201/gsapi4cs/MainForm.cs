...
namespace HFT
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //tc.OrderBookUpdate("OrderBook");
            //tc.OrderBookUpdate("HistOrderBook");
        ...
        private void logOnAll()
        {
            ...
            if (rbProd.Checked)
            {
                ...
                foreach (FileInfo info in di.GetFiles("*.cfg"))
                {
                    ...
                    //剔除非实际账户的cfg文件
                    if (order_cfg.Length < 14)
                        continue;
                    if (order_cfg.Substring(0, 14) != "initiator_prod")
                        continue;

                    FIXTrade tmpTrade = new FIXTrade(order_cfg);
                    AccountDic.Add(order_cfg, tmpTrade);
                }
            }
            else if (rbDebug.Checked)
            {
                ...
                AccountDic.Add("initiator_debug.cfg", tc);
        ...
        private void btTradeSendOrder_Click(object sender, EventArgs e)
        {
            ...
            //  tc.SendOrder(orderType, ticker, quantity, price, checkBoxTradeMarketOrder.Checked, out bufferNotUsed);
            {
                ...
                entry.strategies = TradingStrategies.Other;
        ...
        private void buttonLoadShortFile_Click(object sender, EventArgs e)
        {
            DataClass.SaveShortFileToDB();
        }
        ...
        private void buttonLock_Click(object sender, EventArgs e)
        {
            ...
            string Filename = "";
            Filename = "D:\\Data\\IFArb\\TestList.csv";
            ...
            while (true)
            {
                ...
                if (!String.IsNullOrEmpty(strData))
                {
                    ...
                    //剔除数量为0的股票
                    if (Convert.ToDouble(strValue[3]) > 0)
        ...
        private void buttonCancel_Click(object sender, EventArgs e)
        {
            ...
            entry.ticker = "601299";
            entry.quantityListed = 100;
            entry.priceListed = 10.3;//直接按卖一下市价单

            entry.lockPrice = 11.2;

            entry.orderTime = 130700;
        ...
        private void buttonCancelAndSell_Click(object sender, EventArgs e)
        {
            string ticker = textBoxTradeTicker.Text;
            string quantity = textBoxTradeQuantity.Text;

            Dictionary<string, int> structDict = new Dictionary<string, int>();
            structDict.Add(ticker, Convert.ToInt32(quantity));
